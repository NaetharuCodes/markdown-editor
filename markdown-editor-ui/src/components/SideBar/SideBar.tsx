...
const dummyData = [
  { date: "10.10.2024", title: "Important.md" },
  { date: "24.10.2024", title: "Reminder.md" },
  { date: "03.11.2024", title: "Plan.md" },
];
...
const SideBar = ({ open }: SideBarProps) => {
  ...
  return (
    <div className={`${styles.container} ${open ? styles.openSidebar : ""}`}>
      <h2 className={`app-heading-sm ${styles.heading}`}>MY DOCUMENTS</h2>
